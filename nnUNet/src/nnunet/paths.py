...
base = "./src/nnUNetFrame/DATASET/nnUNet_raw"
preprocessing_output_dir = "./src/nnUNetFrame/DATASET/nnUNet_preprocessed"
network_training_output_dir_base = "./src/nnUNetFrame/DATASET/nnUNet_trained_models"
