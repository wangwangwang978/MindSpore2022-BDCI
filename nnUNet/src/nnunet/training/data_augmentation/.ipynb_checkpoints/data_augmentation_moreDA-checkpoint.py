...
def get_moreDA_augmentation(dataloader_train, dataloader_val, patch_size, params=None,
    ...
    seeds_train = [i for i in range(params.get('num_threads'))]
    seeds_val = [i for i in range(max(params.get('num_threads') // 2, 1))]

    print('seeds_train ', seeds_train, 'seeds_val ', seeds_val)
