        ...
        while self.epoch < self.max_num_epochs:
            ...
            if self.use_progress_bar:
                ...
                for idx in range(self.num_batches_per_epoch):
                    ...
                    l = self.run_iteration(self.tr_gen, True, run_online_evaluation_flag) # True
                    train_losses_epoch.append(l)
            ...
            val_losses = []
            for idx in range(self.num_val_batches_per_epoch):
                ...
                l = self.run_iteration(self.val_gen, False, run_online_evaluation_flag) # True
                val_losses.append(l)
